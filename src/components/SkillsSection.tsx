...
function SkillsSection() {
  ...
  return (
    <section
      id="skills"
      ref={sectionRef}
      className="w-full py-20 px-20 flex flex-col justify-center items-center border-[#0B162C] max-sm:px-5 md:px-1">

      <div className="w-full text-center mb-10">
        <h2 className="underline text-[#0B162C] font-bold lg:text-[50px] md:text-3xl">Compétences</h2>
      </div>
      <div className="w-full grid lg:grid-cols-4 md:grid-cols-3 max-sm:grid-cols-1 gap-y-5">
        {[
          ...
          <motion.div
            key={skill.nom}
            className="flex w-full justify-center items-center px-20 max-sm:px-5 md:px-2"
