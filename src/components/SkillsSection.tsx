...
function SkillsSection() {
  ...
  return (
    <section
      id="skills"
      ref={sectionRef}
      className="w-full  py-20 px-20  flex flex-col justify-center border-[#0B162C] max-sm:px-1 md:px-1">

      <div className="w-full text-center text-5xl mb-10">
        <h2 className="underline text-[#0B162C]">Compétences</h2>
      </div>
      <div className="flex flex-row w-full items-center grid-cols-5 flex-wrap gap-8 justify-center my-5 border-t md:gap-2 py-5 max-sm:grid-cols-2 max-sm:grid-rows-2 max-sm:gap-y-5 max-sm:gap-x-1 md:grid-cols-3">
        {[
