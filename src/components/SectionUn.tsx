...
function SectionUn() {
  ...
  return (
    <>
      ...
      `}</style>
      <section id="presentation" className="bg-[url('/images/bgOne.png')] object-cover bg-cover bg-top h-[650px] w-full lg:px-20 justify-between flex flex-row items-start md:px-5 max-sm:px-5 max-sm:h-[400px] max-sm:items-start max-sm:bg-left">
        <motion.div
