...
const Header: React.FC = () => {
  ...
  return (
    <nav className="bg-transparent h-20 w-full py-6 px-20 items-center justify-between flex flex-row border-b">
        {/*partieUne*/}
        <div>
            <a href="#">
                <h3 className="text-3xl font-bold hover:scale-105 transition-all">Digital-Gick</h3>
            </a>
        </div>
      ...
      <div>
        ...
        <div className="relative xl:hidden lg:hidden md:flex items-center justify-center">
