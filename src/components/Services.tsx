...
import { Code2, ShoppingCart, Globe } from "lucide-react";
...
const Services = () => {
  ...
  return (
    <section id="services" className="relative py-20 xl:py-32 dark:bg-black overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.span
            className="inline-block px-4 py-2 bg-blue-100 dark:bg-black dark:text-gray-200 text-blue-700 rounded-full text-sm font-medium mb-4"
        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
          {services.map((service) => {
            ...
            return (
              ...
              >
                {/* Service Card */}
                <div className="relative bg-white dark:bg-black rounded-2xl p-8 lg:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-400 group-hover:border-transparent h-full flex flex-col">
                  
                  {/* Number Badge */}
                  <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-r from-gray-900 dark:from-gray-200 to-gray-700 dark:to-gray-900  rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg">
                    0{service.id}
                  </div>
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-gray-200 mb-4 group-hover:text-gray-700 transition-colors">
                      {service.title}
                    </h3>
